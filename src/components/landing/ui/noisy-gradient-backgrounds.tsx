...
// Noise component integrated into the background with soft noise
function Noise({
  patternSize = 100,
  patternScaleX = 1,
  patternScaleY = 1,
...
function GradientBackground({
  ...
  colors = [
    { color: 'rgba(254, 81, 5, 0.18)', stop: '0%' },
    { color: 'rgba(245, 120, 20, 0.12)', stop: '25%' },
    { color: 'rgba(18, 18, 24, 0.6)', stop: '70%' },
    { color: 'rgba(9, 9, 11, 0.95)', stop: '100%' },
  ],
  enableNoise = true,
  ...
  return (
    <div className={`noisy-gradient-bg ${className}`} style={gradientStyle} aria-hidden="true">
      {enableNoise && (
        <Noise
